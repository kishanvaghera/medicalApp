  ...
  return (
     <View style={styles.mainScreen}>
      ...
      <View style={styles.tophead}>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate(RoutName.ADMIN_ACTIVITY_ADD,{id:"",name:""})} style={styles.TopHeadBtn}>
            ...
            <View style={styles.boxCard}>
                <Text style={styles.boxEditButton}>
                  <View style={styles.boxButtonRow}>
                    <TouchableOpacity onPress={()=>{props.navigation.navigate(RoutName.ADMIN_ACTIVITY_ADD,{id:props.data.iActivityCatId,name:props.data.vActivitCatName})}}>
