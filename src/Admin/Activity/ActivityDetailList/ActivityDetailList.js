  ...
  return (
    <View style={styles.mainScreen}>
      ...
      <View style={styles.tophead}>
        ...
        <TouchableOpacity style={styles.TopHeadBtn} onPress={()=>navigation.navigate(RoutName.ADMIN_ACTIVITY_DETAIL_ADD,{data:{}})}>
...
const BoxRows=(props)=>{
    const deleteRecord=(id)=>{
      const postData={action:"deleteCommon",tableName:"activity",id:id,whrIdName:'iActivityId'}
    ...
    return <View style={styles.boxRows}>
              <View style={styles.boxCard}>
                  ...
                  <View style={styles.boxEditButton}>
                    <TouchableOpacity onPress={()=>{props.navigation.navigate(RoutName.ADMIN_ACTIVITY_DETAIL_ADD,{data:props.data})}}>
                  ...
                  <View style={styles.boxDelButton}>
                    <TouchableOpacity onPress={()=>{deleteRecord(props.data.iActivityId)}}>
