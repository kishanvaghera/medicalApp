...
const YogaSubCategoryList = ({navigation,route}) => {
    ...
    const RedirectPage=(curEle)=>{
        if(curEle.iSubCategoryData){
            navigation.navigate(RoutName.YOGA_SUB_SUB_CAT_LIST,{data:{iYogaCatId:curEle.iYogaCatId,iSubYogaCatId:curEle.iSubYogaCatId,vSubYogaName:curEle.vSubYogaName}});
        }else{
